      ...
      <div className="container">
        <div className="max-w-2xl mx-auto text-center mb-14">
          ...
          <p className="text-muted-foreground mt-4">
            Preencha o formulário abaixo. Entraremos em contato em instantes!
          </p>
        </div>

        <form onSubmit={onSubmit} className="max-w-2xl mx-auto p-6 sm:p-8 rounded-2xl bg-card border border-border space-y-5 shadow-elegant">
